...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        slabRecipes(
                ...
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_HATCHING_SLAB.get(), ModBlocks.ASPHALT_WITH_WHITE_HATCHING.get(), output);
        slabRecipes(
        ...
        slabRecipes(
                ...
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_RIGHT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_DOUBLE_LEFT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_DOUBLE_LEFT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_DOUBLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_DOUBLE_RIGHT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_DOUBLE_LEFT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_DOUBLE_LEFT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_DOUBLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_DOUBLE_RIGHT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_LEFT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_LEFT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_RIGHT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_LEFT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_LEFT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_RIGHT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_DOUBLE_LEFT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_DOUBLE_LEFT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_DOUBLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_DOUBLE_RIGHT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_DOUBLE_LEFT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_DOUBLE_LEFT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_DOUBLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_DOUBLE_RIGHT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_LEFT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_LEFT_EDGE.get(),
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_RIGHT_EDGE_SLAB.get(),
                ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_RIGHT_EDGE.get(),
                output);
        ...
        slabRecipes(
                ...
                output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_TRIANGLE_SLAB.get(), ModBlocks.ASPHALT_WITH_WHITE_TRIANGLE.get(), output);
        slabRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_BICYCLE_SLAB.get(), ModBlocks.ASPHALT_WITH_YELLOW_BICYCLE.get(), output);
        slabRecipes(
        ...
        paintingRecipes(
                ModBlocks.WARNING_BEACON_LEFT_EU_SIGN.get(), ModTags.BAKE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.WARNING_BEACON_RIGHT_EU_SIGN.get(), ModTags.BAKE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.WARNING_BEACON_ALT_EU_SIGN.get(), ModTags.BAKE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.RIGHT_ARROW_EU_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_TURN_ARROW_EU_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_TURN_ARROW_EU_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.LEFT_ARROW_YELLOW_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_ARROW_YELLOW_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_DIAGONAL_ARROW_YELLOW_US_SIGN.get(),
                ModTags.RECTANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.LEFT_ARROW_GREEN_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_ARROW_GREEN_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.DOUBLE_ARROW_GREEN_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_ARROW_ORANGE_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_ARROW_ORANGE_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.PRIORITY_ROAD_EU_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.PRIORITY_ROAD_END_EU_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.T_INTERSECTION_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.Y_INTERSECTION_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_SIDE_ROAD_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_SIDE_ROAD_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.LEFT_REVERSE_TURN_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_REVERSE_TURN_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_MERGING_TRAFFIC_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.LEFT_ADDED_LINE_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_ADDED_LINE_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_LANE_ENDS_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_LANE_ENDS_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.TWO_WAY_TRAFFIC_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.VERY_SHARP_CURVE_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.WINDING_ROAD_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.HAIRPIN_CURVE_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.DIVIDED_HIGHWAY_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.CREEPER_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.TRUCK_CROSSING_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.PEDESTRIANS_CROSSING_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.HANDICAPED_CROSSING_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BICYCLE_CROSSING_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.PLAYGROUND_AHEAD_US_SIGN.get(), ModTags.RHOMBUS_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.HUNDRED_TWENTY_SPEED_EU_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.NO_TRUCK_PASSING_EU_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.ONGOING_TRAFFIC_EU_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.NO_TRUCK_PASSING_END_EU_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.RAILROAD_CROSSING_US_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.CRAFT_CITY_END_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.END_CALMING_AREA_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ...
                ModTags.SQUARE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(
                ModBlocks.NO_THROUGH_ROAD_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.PARKING_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.PARKING_GARAGE_EU_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.PEDESTRIAN_CROSSING_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.PETROL_STATION_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.WATER_PROTECTION_AREA_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.RIGHT_DIRECTION_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_DIRECTION_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.GUIDE_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_DIRECTION_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_DIRECTION_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.NO_PEDESTRIANS_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.STRAIGHT_AHEAD_ONLY_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_TURN_ONLY_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_TURN_ONLY_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.DIESEL_STATION_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.ELECTRIC_STATION_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.CAMPING_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.MEDICAL_SERVICE_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.DRINKING_WATER_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.LOUNDRY_FACILITY_US_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.SLIPPERINESS_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.ONCOMING_TRAFFIC_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.LEFT_DOUBLE_CURVE_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_DOUBLE_CURVE_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.LEFT_NARROWING_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_NARROWING_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.INTERSECTION_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.YIELD_RIGHT_OF_WAY_EU_SIGN.get(),
                ModTags.UPSIDE_DOWN_TRIANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(
        ...
        paintingRecipes(
                ModBlocks.EXIT_CLOSED_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.NO_HAZARDOUS_CARGO_EU_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.M_AHEAD_EU_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.AHEAD_YELLOW_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BICYCLE_PATH_RIGHT_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BICYCLE_HIGHWAY_END_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.TEN_MINIMUM_SPEED_SIGN_EU.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.HIGHWAY_COUNTDOWN_MARKER_200_EU_SIGN.get(),
                ModTags.BAKE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(
                ModBlocks.BICYCLE_PATH_LEFT_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BICYCLE_ROUTE_AHEAD_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ModBlocks.AHEAD_GREEN_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.MOVABLE_BRIDGE_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ModBlocks.THIRTY_MINIMUM_SPEED_SIGN_EU.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.CHARGING_STATION_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BICYCLE_ROUTE_LEFT_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LOOSE_GRAVEL_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.BICYCLE_HIGHWAY_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.PARKING_AREA_END_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BICYCLE_PATH_AHEAD_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.NO_MONSTER_EU_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.AHEAD_ORANGE_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BICYCLE_ROUTE_RIGHT_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_PRIORITY_ROAD_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.PARKING_AREA_START_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.RIGHT_PRIORITY_ROAD_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.SHORE_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.TREE_OVERHANG_EU_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.TRUCK_ROUTE_AHEAD_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.TRUCK_ROUTE_RIGHT_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.TRUCK_ROUTE_LEFT_EU_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.WARN_US_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.WARNING_BEACON_ALT_US_SIGN.get(), ModTags.BAKE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.WARNING_BEACON_LEFT_US_SIGN.get(), ModTags.BAKE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
        ...
        paintingRecipes(
                ModBlocks.ONCOMING_TRAFFIC_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.INTERSECTION_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.DETOUR_LEFT_OR_RIGHT_CN_SIGN.get(),
                ModTags.TRIANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(
                ModBlocks.PEDESTRIAN_CROSSING_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.FIFTY_ADVISORY_SPEED_CN_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.RIGHT_DOUBLE_CURVE_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.LEFT_DIRECTION_CN_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_NARROWING_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.LEFT_NARROWING_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.NATURE_RESERVE_AREA_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_MERGING_TRAFFIC_CN_SIGN.get(),
                ModTags.TRIANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(ModBlocks.HIGHWAY_END_CN_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.LEFT_DOUBLE_CURVE_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.PARKING_GARAGE_CN_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.DETOUR_RIGHT_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.THIRTY_ADVISORY_SPEED_CN_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RIGHT_DIRECTION_CN_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.NARROW_BRIDGE_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.FORTY_ADVISORY_SPEED_CN_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.RIGHT_MERGING_TRAFFIC_CN_SIGN.get(),
                ModTags.TRIANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        ...
        paintingRecipes(
                ModBlocks.SIDE_ROAD_AT_ANGLE_LEFT_CN_SIGN.get(),
                ModTags.TRIANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(
                ModBlocks.SIDE_ROAD_AT_ANGLE_RIGHT_CN_SIGN.get(),
                ModTags.TRIANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        paintingRecipes(
                ModBlocks.SIDE_ROAD_AT_LEFT_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.SIDE_ROAD_AT_RIGHT_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.SIGNAL_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.SLIPPERINESS_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.T_INTERSECTION_CN_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.MONSTER_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.TOXIC_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.VOLTAGE_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.MAGNETIC_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.EXPLOSION_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.GAS_CYLINDER_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.RADIATION_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.BIOHAZARD_WARNING_SIGN.get(), ModTags.TRIANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.PROHIBITION_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.ENTERING_PROHIBITED_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.HEAVY_LOAD_PROHIBITED_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.DRINKING_PROHIBITED_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.PHONES_PROHIBITED_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.PEDESTRIANS_PROHIBITED_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.UNAUTHORISED_PROHIBITED_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.SMOKING_PROHIBITED_SIGN.get(), ModTags.ROUND_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        ...
        paintingRecipes(
                ModBlocks.FIRE_EXTINGUISHER_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.ASSEMBLY_POINT_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.EMERGENCY_TELEFONE_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(ModBlocks.EMERGENCY_EXIT_SIGN.get(), ModTags.SQUARE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.EMERGENCY_EXIT_LEFT_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.EMERGENCY_EXIT_RIGHT_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.EMERGENCY_EXIT_AHEAD_SIGN.get(), ModTags.RECTANGLE_SIGN_TAG, ModItems.DYE_MIX.get(), output);
        paintingRecipes(
                ModBlocks.EMERGENCY_EXIT_DOWNWARDS_SIGN.get(),
                ModTags.RECTANGLE_SIGN_TAG,
                ModItems.DYE_MIX.get(),
                output);
        ...
        paintingRecipes(
                ModBlocks.ORANGE_CONCRETE_WALL.get(), ModTags.CONCRETE_WALLS_TAG, Tags.Items.DYES_ORANGE, output);
        paintingRecipes(
                ModBlocks.MAGENTA_CONCRETE_WALL.get(), ModTags.CONCRETE_WALLS_TAG, Tags.Items.DYES_MAGENTA, output);
        paintingRecipes(
                ModBlocks.LIGHT_BLUE_CONCRETE_WALL.get(),
                ModTags.CONCRETE_WALLS_TAG,
                Tags.Items.DYES_LIGHT_BLUE,
                output);
        paintingRecipes(
                ModBlocks.YELLOW_CONCRETE_WALL.get(), ModTags.CONCRETE_WALLS_TAG, Tags.Items.DYES_YELLOW, output);
        ...
        paintingRecipes(
                ModBlocks.PURPLE_CONCRETE_WALL.get(), ModTags.CONCRETE_WALLS_TAG, Tags.Items.DYES_PURPLE, output);
        ...
        paintingRecipes(
                ModBlocks.LIGHT_BLUE_ASPHALT.get(), ModTags.BLANK_ASPHALT_TAG, Tags.Items.DYES_LIGHT_BLUE, output);
        ...
        paintingRecipes(
                ModBlocks.LIGHT_GRAY_ASPHALT.get(), ModTags.BLANK_ASPHALT_TAG, Tags.Items.DYES_LIGHT_GRAY, output);
        ...
        paintingRecipes(
                ModBlocks.WHITE_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ORANGE_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_ORANGE, output);
        paintingRecipes(
                ModBlocks.MAGENTA_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_MAGENTA, output);
        paintingRecipes(
                ModBlocks.LIGHT_BLUE_ASPHALT_SLAB.get(),
                ModTags.BLANK_ASPHALT_SLABS_TAG,
                Tags.Items.DYES_LIGHT_BLUE,
                output);
        paintingRecipes(
                ModBlocks.YELLOW_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.LIME_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_LIME, output);
        paintingRecipes(
                ModBlocks.PINK_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_PINK, output);
        paintingRecipes(
                ModBlocks.GRAY_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_GRAY, output);
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.CYAN_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_CYAN, output);
        paintingRecipes(
                ModBlocks.PURPLE_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_PURPLE, output);
        paintingRecipes(
                ModBlocks.BLUE_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_BLUE, output);
        paintingRecipes(
                ModBlocks.BROWN_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_BROWN, output);
        paintingRecipes(
                ModBlocks.GREEN_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_GREEN, output);
        paintingRecipes(
                ModBlocks.RED_ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_RED, output); //
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_FRAME.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_EDGE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_STRAIGHT_ARROW.get(),
                ModBlocks.ASPHALT_BLOCK.get(),
                Tags.Items.DYES_WHITE,
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_A.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_B.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_C.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_D.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_E.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_F.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_G.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_H.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_I.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_J.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_K.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_L.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_M.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_N.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_O.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_P.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_Q.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_R.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_S.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_T.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_U.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_V.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_W.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_X.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
        ...
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_0.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_1.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_2.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_3.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_4.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_5.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_6.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_7.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_8.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_9.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
        ...
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_DOT.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_EXCLAMATION.get(),
                ModBlocks.ASPHALT_BLOCK.get(),
                Tags.Items.DYES_WHITE,
        ...
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_0.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_1.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_2.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_3.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_4.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_5.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_6.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_7.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_8.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_9.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_COMMA.get(),
                ModBlocks.ASPHALT_BLOCK.get(),
                Tags.Items.DYES_YELLOW,
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_A.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_B.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_C.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_D.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_E.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_F.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_G.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_H.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_I.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_J.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_K.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_L.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_M.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_N.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_O.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_P.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_Q.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_R.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_S.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_T.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_U.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_V.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_W.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_X.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_Y.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_YELLOW_Z.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELLOW, output);
        ...
        paintingRecipes(
                ...
                output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_A_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_B_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_C_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_D_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_E_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_F_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_G_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_H_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_I_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_J_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_K_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_L_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_M_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_N_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_O_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_P_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_Q_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_R_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_S_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_T_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_U_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_V_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_W_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
                ModBlocks.ASPHALT_WITH_WHITE_X_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHITE, output);
        paintingRecipes(
        ...
        paintingRecipes(
                Blocks.LIGHT_BLUE_CONCRETE_POWDER, ModTags.CONCRETE_POWDER_TAG, Tags.Items.DYES_LIGHT_BLUE, output);
        ...
        paintingRecipes(
                Blocks.LIGHT_GRAY_CONCRETE_POWDER, ModTags.CONCRETE_POWDER_TAG, Tags.Items.DYES_LIGHT_GRAY, output);
        ...
        paintingRecipes(
                Blocks.MAGENTA_GLAZED_TERRACOTTA, ModTags.GLAZED_TERRACOTTA_TAG, Tags.Items.DYES_MAGENTA, output);
        paintingRecipes(
                Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA, ModTags.GLAZED_TERRACOTTA_TAG, Tags.Items.DYES_LIGHT_BLUE, output);
        ...
        paintingRecipes(
                Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA, ModTags.GLAZED_TERRACOTTA_TAG, Tags.Items.DYES_LIGHT_GRAY, output);
        ...
        paintingRecipes(
                Blocks.LIGHT_BLUE_STAINED_GLASS_PANE, Tags.Items.GLASS_PANES, Tags.Items.DYES_LIGHT_BLUE, output);
        ...
        paintingRecipes(
                Blocks.LIGHT_GRAY_STAINED_GLASS_PANE, Tags.Items.GLASS_PANES, Tags.Items.DYES_LIGHT_GRAY, output);
        ...
        paintingRecipes(
                Blocks.SMOOTH_SANDSTONE_STAIRS, Blocks.SMOOTH_RED_SANDSTONE_STAIRS, Tags.Items.DYES_YELLOW, output);
        paintingRecipes(
                Blocks.SMOOTH_RED_SANDSTONE_STAIRS, Blocks.SMOOTH_SANDSTONE_STAIRS, Tags.Items.DYES_RED, output);
        ...
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_LANE_OPEN.get(), ModBlocks.STRAIGHT_AHEAD_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_LANE_CLOSED.get(), ModBlocks.CROSS_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_LANE_CHANGE_LEFT.get(), ModBlocks.PASS_LEFT_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_LANE_CHANGE_RIGHT.get(), ModBlocks.PASS_RIGHT_EU_SIGN.get(), output);

        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_SIXTY_SPEED_LIMIT.get(), ModBlocks.SIXTY_SPEED_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_EIGHTY_SPEED_LIMIT.get(), ModBlocks.EIGHTY_SPEED_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
        ...
        variableTrafficSignRecipes(
                ...
                output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_CREEPER.get(), ModBlocks.CREEPER_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_DANGER.get(), ModBlocks.DANGER_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_END_ALL_LIMITS.get(), ModBlocks.END_ALL_LIMITS_EU_SIGN.get(), output);
        variableTrafficSignRecipes(ModBlocks.VARIABLE_TRAFFIC_SIGN_JAMS.get(), ModBlocks.JAMS_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_NO_PASSING.get(), ModBlocks.NO_PASSING_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_NO_TRUCK_PASSING.get(),
                ModBlocks.NO_TRUCK_PASSING_EU_SIGN.get(),
                output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_ROADWORKS.get(), ModBlocks.ROADWORKS_EU_SIGN.get(), output);
        variableTrafficSignRecipes(
                ModBlocks.VARIABLE_TRAFFIC_SIGN_SLIPPERINESS.get(), ModBlocks.SLIPPERINESS_EU_SIGN.get(), output);
    ...
    protected static void simpleShapelessRecipes(
            Block result, TagKey<Item> firstInput, Item secondInput, RecipeOutput output, String group) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, result, 1)
                .requires(firstInput)
    ...
    protected static void stoneCuttingRecipes(
            Block result, Integer resultCount, TagKey<Item> input, RecipeOutput output) {
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(input), RecipeCategory.BUILDING_BLOCKS, result, resultCount)
    ...
    protected static void paintingRecipes(Block result, Object input, Object color, RecipeOutput output) {
        ...
        if (color instanceof Item itemColor) {
            ...
            throw new IllegalArgumentException(
                    "Invalid color type: " + color.getClass().getSimpleName());
        }

        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(
                References.MODID, "painting/" + resultName + "_from_" + inputName);

...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        //paintingRecipes(ModBlocks.RED_CHAIN.get(), ModTags.CHAINS_TAG, Tags.Items.DYES_D, output);
        ...
        //paintingRecipes(ModBlocks.BLACK_CHAIN.get(), ModTags.CHAINS_TAG, Tags.Items.DYES_BLACK, outpu;
        ////paintingRecipes(Blocks.CHAIN, ModTags.CHAINS_TAG, Tags.Items.DYES_GRAY, output);///
        //paintingRecipes(ModBlocks.RED_POLE.get(), ModTags.IRON_POLES_TAG, Tags.Items.DYES_D, output);
        ...
        //paintingRecipes(ModBlocks.RED_POST.get(), ModTags.STONE_POSTS_TAG, Tags.Items.DYES_D, output);
        ...
        //paintingRecipes(ModBlocks.BLACK_CONCRETE_WALL.get(), ModTags.CONCRETE_WALLS_TAG, Tags.Items.DYES_BLK, output);
        ...
        //paintingRecipes(ModBlocks.ASPHALT_BLOCK.get(), ModTags.BLANK_ASPHALT_TAG, Tags.Items.DYES_BLK, output);
        ...
        //paintingRecipes(ModBlocks.ASPHALT_SLAB.get(), ModTags.BLANK_ASPHALT_SLABS_TAG, Tags.Items.DYES_BLK, output);
        ...
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_MIDDLE_LINE.get(), ModTags.ASPHALT_WITH_WHITE_MARKINGS_TAG, Tags.Items.DYES_WHE, output);
        ...
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Its.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_SOLID_AND_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_HATCHING.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_SIDE_DOTS.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_BROKEN_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_FRAME.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_EDGE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_STRAIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_LEFT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_STRAIGHT_AND_LEFT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_RIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_STRAIGHT_AND_RIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DOUBLE_SIDE_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_SOLID_AND_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_BROKEN_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_DIAGONAL_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_FRAME.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_EDGE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_HATCHING.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_A.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_B.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_C.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_D.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_E.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_F.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_G.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_H.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_I.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_J.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_K.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_L.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_M.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_N.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_O.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_P.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_Q.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_R.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_S.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_T.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_U.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_V.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_W.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_X.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_Y.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_Z.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output);////

        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_MIDDLE_LINE.get(), ModTags.ASPHALT_WITH_YELLOW_MARKINGS_TAG, Tags.Items.DYES_YELW, output);
        ...
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Its.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_SOLID_AND_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_HATCHING.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_SIDE_DOTS.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_BROKEN_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_SIDE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_FRAME.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_EDGE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_STRAIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_LEFT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_STRAIGHT_AND_LEFT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_RIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_STRAIGHT_AND_RIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DOUBLE_SIDE_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_SOLID_AND_BROKEN_MIDDLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_BROKEN_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_DIAGONAL_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_DIAGONAL_DOUBLE_LINE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_FRAME.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_EDGE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_HATCHING.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_A.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_B.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_C.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_D.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_E.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_F.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_G.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_H.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_I.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_J.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_K.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_L.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_M.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_N.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_O.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_P.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_Q.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_R.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_S.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_T.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_U.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_V.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_W.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_X.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_Y.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_Z.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;//

        //////SLABS
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_MIDDLE_LINE_SLAB.get(), ModTags.ASPHALT_SLABS_WITH_WHITE_MARKINGS_TAG, Ta.Ite.DYES_WHITE, output);
        ...
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Its.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_MIDDLE_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_SOLID_AND_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BROKEN_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_HATCHING_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_SIDE_DOTS_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_BROKEN_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_FRAME_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_EDGE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_STRAIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_LEFT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_STRAIGHT_AND_LEFT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_RIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_STRAIGHT_AND_RIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DOUBLE_SIDE_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_MIDDLE_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_SOLID_AND_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_BROKEN_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_DIAGONAL_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_FRAME_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_EDGE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_THICK_HATCHING_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_A_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_B_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_C_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_D_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_E_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_F_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_G_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_H_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_I_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_J_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_K_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_L_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_M_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_N_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_O_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_P_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_Q_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_R_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_S_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_T_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_U_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_V_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_W_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_X_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_Y_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_Z_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output);////

        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_MIDDLE_LINE_SLAB.get(), ModTags.ASPHALT_SLABS_WITH_YELLOW_MARKINGS_TAG, Tags.Items.DYES_YELW, output);
        ...
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Its.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_MIDDLE_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_SOLID_AND_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BROKEN_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_HATCHING_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_SIDE_DOTS_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_BROKEN_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_SIDE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_FRAME_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_EDGE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_STRAIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_LEFT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_STRAIGHT_AND_LEFT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_RIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_STRAIGHT_AND_RIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DOUBLE_SIDE_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_MIDDLE_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_SOLID_AND_BROKEN_MIDDLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_BROKEN_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_DIAGONAL_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_DIAGONAL_DOUBLE_LINE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_FRAME_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_EDGE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_THICK_HATCHING_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_A_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_B_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_C_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_D_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_E_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_F_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_G_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_H_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_I_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_J_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_K_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_L_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_M_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_N_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_O_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_P_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_Q_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_R_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_S_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_T_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_U_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_V_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_W_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_X_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_Y_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_Z_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output);////

        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BICYCLE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Its.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_LEFT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_RIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_HANDICAPPED.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_PEDESTRIAN.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_TRIANGLE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_BICYCLE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_LEFT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_DIAGONAL_RIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_HANDICAPPED_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_PEDESTRIAN_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_WHITE_TRIANGLE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_WHI, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BICYCLE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_LEFT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_RIGHT_ARROW.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_HANDICAPPED.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_PEDESTRIAN.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_TRIANGLE.get(), ModBlocks.ASPHALT_BLOCK.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_BICYCLE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_LEFT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_DIAGONAL_RIGHT_ARROW_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_HANDICAPPED_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_PEDESTRIAN_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output)//;
        //paintingRecipes(ModBlocks.ASPHALT_WITH_YELLOW_TRIANGLE_SLAB.get(), ModBlocks.ASPHALT_SLAB.get(), Tags.Items.DYES_YELL, output);
...
//
    ...
    //        baseObject.addProperty("item", BuiltInRegistries.BLOCK.getKey((Block) input).toString());
...
//
    ...
    //        colorObject.addProperty("item", BuiltInRegistries.ITEM.getKey((Item) color).toString());
...
//
    ...
    //    resultObject.addProperty("item", BuiltInRegistries.ITEM.getKey(result.asItem()).toString());
...
//
    //    if (input instanceof Block) {
    //        inputName = BuiltInRegistries.BLOCK.getKey((Block) input).getPath();
    //    } else if (input instanceof TagKey) {
    //        inputName = "tag";
    //    } else {

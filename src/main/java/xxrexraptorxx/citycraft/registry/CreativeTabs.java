...
public class CreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB = CREATIVE_MODE_TABS.register(References.MODID + ".main",
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + References.MODID + ".main_tab"))
                    .icon(() -> new ItemStack(ModBlocks.YELLOW_BLACK_POST.get())).displayItems((params, output) -> {
                        ...
                        output.accept(ModBlocks.NETHER_FLOWER_BOX.get());
                        output.accept(ModBlocks.BLACKSTONE_FLOWER_BOX.get());
                        output.accept(ModBlocks.DEEPSLATE_FLOWER_BOX.get());
                        output.accept(ModBlocks.TUFF_FLOWER_BOX.get());
                        output.accept(ModBlocks.STONE_FLOWER_BOX.get());
                        output.accept(ModBlocks.RED_SANDSTONE_FLOWER_BOX.get());
                        output.accept(ModBlocks.SANDSTONE_FLOWER_BOX.get());
                        output.accept(ModBlocks.QUARTZ_FLOWER_BOX.get());
                        output.accept(ModBlocks.WHITE_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.LIGHT_GRAY_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.GRAY_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.BLACK_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.BROWN_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.RED_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.ORANGE_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.YELLOW_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.LIME_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.GREEN_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.CYAN_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.LIGHT_BLUE_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.BLUE_CONCRETE_FLOWER_BOX.get());
                        output.accept(ModBlocks.PURPLE_CONCRETE_FLOWER_BOX.get());
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BARRIERS_TAB = CREATIVE_MODE_TABS.register(References.MODID + ".barriers",
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + References.MODID + ".barriers_tab"))
                    .icon(() -> new ItemStack(ModBlocks.YELLOW_BLACK_TRAFFIC_BARRIER.get())).withTabsBefore(MAIN_TAB.getId()).displayItems((params, output) -> {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SIGN_TAB = CREATIVE_MODE_TABS.register(References.MODID + ".signs",
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + References.MODID + ".signs_tab"))
                    .icon(() -> new ItemStack(ModBlocks.LEFT_DIAGONAL_ARROW_YELLOW_US_SIGN.get())).withTabsBefore(BARRIERS_TAB.getId()).displayItems((params, output) -> {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CONCRETE_TAB = CREATIVE_MODE_TABS.register(References.MODID + ".concrete",
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + References.MODID + ".concrete_tab"))
                    .icon(() -> new ItemStack(ModBlocks.CHISELED_LIGHT_GRAY_CONCRETE.get())).withTabsBefore(ROAD_TAB.getId()).displayItems((params, output) -> {
                        ...
                        output.accept(ModBlocks.WHITE_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.LIGHT_GRAY_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.GRAY_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.BLACK_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.BROWN_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.RED_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.ORANGE_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.YELLOW_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.LIME_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.GREEN_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.CYAN_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.LIGHT_BLUE_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.BLUE_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.PURPLE_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.MAGENTA_CONCRETE_CRACKED_BRICKS.get());
                        output.accept(ModBlocks.PINK_CONCRETE_CRACKED_BRICKS.get());
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BRICKS_TAB = CREATIVE_MODE_TABS.register(References.MODID + ".bricks",
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + References.MODID + ".bricks_tab"))

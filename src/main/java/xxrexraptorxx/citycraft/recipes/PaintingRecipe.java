...
public class PaintingRecipe implements IPaintingRecipe {
    ...
    public static class Serializer implements RecipeSerializer<PaintingRecipe> {
        ...
        private static final MapCodec<PaintingRecipe> CODEC = RecordCodecBuilder.mapCodec((builder) -> {
            return builder
                    .group(ResourceLocation.CODEC.fieldOf("type").forGetter((recipe) -> recipe.id), Ingredient.CODEC.fieldOf("base").forGetter((recipe) -> recipe.base),
                            Ingredient.CODEC.fieldOf("color").forGetter((recipe) -> recipe.color), ItemStack.OPTIONAL_CODEC.fieldOf("result").forGetter((recipe) -> recipe.result))

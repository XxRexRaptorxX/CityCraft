...
public class CityCraft {
    ...
    public static final ResourceLocation MAIN_TAB = new ResourceLocation(References.MODID, "main_tab");
    public static final ResourceLocation ROADS_TAB = new ResourceLocation(References.MODID, "roads_tab");
    public static final ResourceLocation SIGNS_TAB = new ResourceLocation(References.MODID, "signs_tab");

    public CityCraft() {
        Mod.EventBusSubscriber.Bus.MOD.bus().get().register(CityCraft.class);
    ...
    public static void registerTabs(final CreativeModeTabEvent.Register event) {
        event.registerCreativeModeTab(MAIN_TAB, (cf) -> cf.icon(() -> new ItemStack(ModBlocks.YELLOW_BLACK_POST.get()))
                .title(Component.translatable("itemGroup." + References.MODID + ".main_tab")).displayItems((params, output) -> {
        ...
        event.registerCreativeModeTab(SIGNS_TAB, (cf) -> cf.icon(() -> new ItemStack(ModBlocks.CREEPER_EU_SIGN.get()))
                .title(Component.translatable("itemGroup." + References.MODID + ".signs_tab")).displayItems((params, output) -> {
                    // EU
        ...
        event.registerCreativeModeTab(ROADS_TAB, (cf) -> cf.icon(() -> new ItemStack(ModBlocks.ASPHALT_WITH_WHITE_THICK_BROKEN_MIDDLE_LINE.get()))
                .title(Component.translatable("itemGroup." + References.MODID + ".roads_tab")).displayItems((params, output) -> {
